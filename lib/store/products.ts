...
export const STORE_PRODUCTS: StoreProduct[] = [
  {
    ...
    description: "High-density, live marine culture with cold-chain shipping included.",
    bullets: ["Batch tracked", "Live culture, high density", "Shipping included"],
  ...
  },
  {
    ...
    sizeLabel: "32oz",
    name: "Live Phytoplankton",
    description: "Best-selling size for mixed reefs with shipping included.",
    bullets: ["Most popular size", "Shipping included", "Ideal for frequent dosing"],
    badge: "Best value",
  ...
  },
  {
    ...
    sizeLabel: "64oz",
    name: "Live Phytoplankton",
    description: "High-volume supply for larger systems with shipping included.",
    bullets: ["Best for larger reefs", "Shipping included", "Fewer re-orders, consistent dosing"],
    badge: "High volume",
