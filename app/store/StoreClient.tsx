    ...
    <main className="pt-20">
      ...
      <section className="rc-section bg-band">
        <div className="rc-container">
          ...
          <div className="mt-9 rounded-3xl border border-white/10 bg-white/5 p-5 text-sm text-white/80">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <div className="text-[11px] font-semibold uppercase tracking-[0.22em] text-white/55">Shipping</div>
                <div className="mt-1 text-base font-semibold text-white">$12 cold-chain shipping under $50 • free shipping at $50+</div>
              </div>
              <div className="text-[11px] uppercase tracking-[0.22em] text-white/50">Fresh bottles • packed cold • secure Stripe checkout</div>
            </div>
          </div>

          <div className="mt-6 rounded-3xl border border-[rgba(29,211,197,0.2)] bg-[rgba(29,211,197,0.06)] p-5 text-sm text-white/80">
            <div className="text-[11px] font-semibold uppercase tracking-[0.22em] text-[rgba(29,211,197,0.85)]">Subscribe & save</div>
            <div className="mt-1 text-base font-semibold text-white">Monthly auto-ship is ready to wire once your recurring Stripe prices are added.</div>
            <div className="mt-2 text-white/65">The checkout and dashboard are prepared for recurring orders, but your Stripe recurring price IDs still need to be created in Stripe.</div>
          </div>
