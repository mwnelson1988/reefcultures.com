...
function galleryForSlug(slug: string) {
  if (slug.includes("64")) return ["/images/bottles/IMG_0094.jpeg", "/images/bottles/IMG_0093.jpeg", "/images/bottles/IMG_0092.jpeg"];
  if (slug.includes("32")) return ["/images/bottles/IMG_0093.jpeg", "/images/bottles/IMG_0092.jpeg", "/images/bottles/IMG_0094.jpeg"];
  return ["/images/bottles/IMG_0092.jpeg", "/images/bottles/IMG_0093.jpeg", "/images/bottles/IMG_0094.jpeg"];
}
            ...
            <div>
              ...
              <Reveal delay={0.08}>
                <div className="mt-6 rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-white/75">
                  <div className="text-[11px] uppercase tracking-[0.22em] text-white/55">Shipping</div>
                  <div className="mt-1 font-semibold text-white">$12 cold-chain shipping under $50 • free shipping at $50+</div>
                </div>
              </Reveal>
              ...
              <div className="grid gap-4 sm:grid-cols-3 lg:grid-cols-1">
                <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/5 p-4 sm:col-span-3 lg:col-span-1">
                  <div className="relative h-[420px] w-full overflow-hidden rounded-2xl bg-black/20">
                    <Image src={gallery[0]} alt={`${product.name} ${product.size}`} fill className="object-cover object-center" />
                  </div>
                </div>
                <div className="grid grid-cols-3 gap-4 sm:col-span-3 lg:grid-cols-3">
                  {gallery.map((src) => (
                    <div key={src} className="relative h-[130px] overflow-hidden rounded-2xl border border-white/10 bg-white/5">
