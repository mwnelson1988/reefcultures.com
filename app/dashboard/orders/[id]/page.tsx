      ...
      <div className="paper-shell">
        <Container className="py-16">
          <Card>
            ...
            <div className="mt-6">
              <Button href="/dashboard/orders" className="px-6 py-3">
                Back to orders
              </Button>
            </div>
          </Card>
          ...
          <div className="mx-auto max-w-6xl">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
              ...
              <div className="flex gap-3">
                <Button href="/dashboard/orders" variant="secondary" className="px-6 py-3">
                  Back
                </Button>
            ...
            <div className="lg:col-span-4 space-y-6">
              ...
              <Card>
                ...
                <div className="mt-4 flex flex-col gap-3">
                  <Button href="/dashboard" variant="secondary" className="px-6 py-3">
                    Dashboard overview
                  </Button>
                  <Button href="/dashboard/orders" className="px-6 py-3">
                    Orders list
