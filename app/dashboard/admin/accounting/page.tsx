...
export default async function AccountingPage({
  ...
  const netAfterReturns = stripeSummary?.net_after_refunds_cents ?? curRevenue;
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-white/10 bg-white/5 p-6">
        ...
        <div className="mt-6 grid gap-4 sm:grid-cols-2 xl:grid-cols-5">
          ...
          <Kpi label="Orders" value={String(curOrders)} delta={win.compareStart ? deltaPct(curOrders, compareOrders) : null} />
          <Kpi label="AOV" value={centsToUsd(curAov)} delta={null} />
          <Kpi label="Net After Returns" value={centsToUsd(netAfterReturns)} delta={null} />
        </div>
        ...
        {stripeSummary ? (
          <div className="mt-4 rounded-2xl border border-white/10 bg-black/20 p-4">
            ...
            <div className="mt-2 grid gap-3 sm:grid-cols-4 lg:grid-cols-5">
              ...
              <MiniKpi label="Refunds" value={centsToUsd(stripeSummary.refunds_cents)} />
              <MiniKpi label="Net" value={centsToUsd(stripeSummary.net_cents)} />
              <MiniKpi label="Net After Returns" value={centsToUsd(stripeSummary.net_after_refunds_cents)} />
            </div>
      ...
      <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
        ...
        <div className="mt-2 text-sm text-white/70">
          Net After Returns uses Stripe gross charges minus Stripe fees and refunds inside the selected window.
        </div>
      </div>
    </div>
  );
