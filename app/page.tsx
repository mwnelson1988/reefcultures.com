...
const pillars = [
  ...
  },
  {
    ...
    desc: "The buying experience, packaging language, and information architecture match a serious reef brand.",
  },
];
        ...
        <div className="rc-container">
          <div className="grid gap-12 lg:grid-cols-12">
            <div className="lg:col-span-4">
              <Reveal>
                <div className="rc-kicker text-muted">Why it converts better</div>
                <h2 className="mt-4 text-display font-bold">
                  A clearer buying path for a premium reef brand.
                </h2>
                <p className="mt-6 text-muted leading-relaxed">
                  Reef hobbyists do not just buy a bottle. They buy confidence in
                  handling, shipping, consistency, and the routine they are building.
                </p>
              </Reveal>
            </div>
