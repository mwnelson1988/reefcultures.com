    ...
    <Card className="p-6 flex flex-col">
      ...
      <div className="mt-6 flex items-end justify-between">
        ...
        <div className="text-right">
          ...
          <div className="mt-2 inline-flex items-center rounded-xl border border-brand-border bg-brand-card/50 overflow-hidden">
            <button
              type="button"
              className="px-3 py-2 text-sm hover:bg-brand-muted/40 transition"
      ...
      {open ? (
        <div className="fixed inset-0 z-[100] flex items-center justify-center">
          <button
            ...
            onClick={closeModal}
          />
          <div className="relative w-[min(92vw,720px)] rounded-2xl border border-brand-border bg-brand-bg p-6 shadow-2xl">
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                type="button"
                onClick={closeModal}
                className="rounded-xl border border-brand-border bg-brand-card/50 px-3 py-2 text-sm hover:bg-brand-muted/40 transition"
              >
                Close
              </button>
            </div>
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              <div className="md:col-span-2">
                ...
                <input
                  className="mt-2 w-full rounded-xl border border-brand-border bg-brand-card/50 px-3 py-2 text-sm outline-none"
                  value={addr.name}
                ...
                <div className="mt-3 grid gap-2">
                  {rates.map((r) => {
                    ...
                    return (
                      <label
                        key={r.object_id}
                        className="flex cursor-pointer items-center justify-between gap-3 rounded-2xl border border-brand-border bg-brand-card/40 px-4 py-3 hover:bg-brand-muted/30 transition"
                      >
